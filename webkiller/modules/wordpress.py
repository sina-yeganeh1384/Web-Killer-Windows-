...
def wp_plug():
    try:
        print(Fore.LIGHTRED_EX + ' [*] Enter The Wordpress Address \n')
        target = input(Fore.BLUE + ' [@] enter: >>>').lower()

        if target == '':
            print(Fore.RED + ' [!] Get Lost!!! ')
            time.sleep(3)
            sys.exit()

        s = requests.get('http://' + target + '/wp-content/plugin/')

        if s.status_code == 400 or s.status_code == 500:
            print(Fore.RED + ' [!] Site Is Not Word Press ')
            time.sleep(3)
            sys.exit()
        else:
            pass
        ...
        time.sleep(1)
        print(Fore.YELLOW + ' [.] Scanning 1000 Best Plugin... \n')
        time.sleep(3)
        print(Fore.YELLOW + ' [.] Loading 1000 Best Plugin... \n')
        time.sleep(3)
        print(Fore.YELLOW + ' [.] Please Wate !')
    except:
        print('')
    ...
    for i in pl:
        time.sleep(0.1)
        try:
            r = requests.get('http://' + target + '/wp-content/plugin/' + i)
            if r.status_code == 200:
                print(Fore.GREEN + ' [+] http://' + target + Fore.GREEN + '/wp-content/plugin/' + i + Fore.GREEN + ' ~ Found')
            else:
                print(Fore.LIGHTRED_EX + ' [-] http://' + target + Fore.LIGHTRED_EX + '/wp-content/plugin/' + i + Fore.LIGHTRED_EX + ' ~ Not Found')
        except:
            print('')
    try:
...
def user():
    try:
        ...
        if target == '':
            print(Fore.IGHTRED_EX + ' [!] Get Lost!!! ')
            time.sleep(3)
            sys.exit()
        ...
        if s.status_code == 400 or s.status_code == 500:
            print(Fore.IGHTRED_EX + ' [!] Site Is Not Word Press ')
            time.sleep(3)
            sys.exit()
        else:
            pass
        ...
        try:
            r = requests.get('https://' + target + '/wp-json/wp/v2/users/').text
            j = json.loads(r)
            count = len(j)
            cn = 0
            user = ''
            for val in j:
                ...
                if count == cn:
                    ...
                    u = j[cn]['slug']
                if not u == '':
                    user = (Fore.GREEN + ' [+] ' + Fore.GREEN + u + split)

                cn += 1
                if user == '':
                    user = (Fore.LIGHTRED_EX + ' [-] Not Found')
